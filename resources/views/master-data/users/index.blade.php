                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="role_id" class="form-select @if($errors->has('role_id') && session('open_modal') === 'createUserModal') is-invalid @endif" required>
                    ...
                    <form method="POST" action="{{ route('users.update', $user) }}">
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <label class="form-label">Role</label>
                                    <select name="role_id" class="form-select @if($errors->has('role_id') && session('open_modal') === 'editUserModal-' . $user->id) is-invalid @endif" required>
                                        <option value="">Select role</option>
                                        @foreach ($roles as $role)
                                            <option value="{{ $role->id }}" @selected((string) (session('open_modal') === 'editUserModal-' . $user->id ? old('role_id', $user->role_id) : $user->role_id) === (string) $role->id)>{{ $role->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4">
